...
import '../../styles/photo_upload.less';
...
class ReactImageUploadComponent extends React.Component {
  ...
  componentDidMount() {
    if (this.props.defaultImages && this.props.defaultImages.length > 0) {
      this.onDropFiles(this.props.defaultImages)
    }
  }
    ...
    return this.state.pictures.map((picture, index) => {
      return (
        <div key={index} className="uploadPictureContainer">
          <div className="deleteImage" onClick={() => this.removeImage(picture)}><Icon name="x"/></div>
